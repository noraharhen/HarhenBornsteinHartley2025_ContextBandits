...
jsPsych.plugins["make_decision"] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    pirates = new Image();
    pirates.src = '../../make_stim/stims-05.png';

    pirates.onload = function(){
      c_ctx.drawImage(pirates, c.width / 2 - (pirates.width*0.6) / 2,
      c.height - (pirates.height*0.6)/1.0,pirates.width*0.6, pirates.height*0.6);
    }
  }
