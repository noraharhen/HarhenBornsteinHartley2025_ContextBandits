...
jsPsych.plugins["do_trial_prac"] = (function () {
  ...
  var show_outcome = function() {
    ...
    jsPsych.pluginAPI.setTimeout(function(){trial.rewards[3].show();}, 3000);
    ...
    jsPsych.pluginAPI.setTimeout(function(){trial.miscell[0].hide(); trial.miscell[1].hide();trial.pirates[key_pressed].hide();
      trial.rewards[3].hide();trial.miscell[10].hide();trial.miscell[4].hide();trial.miscell[5].hide();end_trial();}, 4500);
